...
public class LoginFilter extends HttpFilter {
    ...
    protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
        if (isSiteIndex(req) || isResourceReq(req) || isSiteAllowed(req) || isUserLogged(req)) {
    ...
    private boolean isSiteIndex(HttpServletRequest req) {
        return req.getRequestURI().equals(req.getContextPath() + "/index.xhtml") ||
